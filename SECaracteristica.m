...
%         
        disp("raio médio da pupila: "+RaioDaPupilaM);
...
%         Normalizado = WalletGabor(Normalizado, 4, 6, 3, 1.7, 0.65, 1.3);%Ainda não implementado        
...
% OLD   Não ler codigos para possivel uso no futuro
%         %Histograma
%         
%         Img = histeq(Img);
%         
